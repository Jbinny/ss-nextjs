...
export default function Menu() {
  ...
  return (
      <ul className={styles['main-menu']}>
        ...
        <li className={styles['item']} onMouseEnter={handleMouseHover} onMouseOut={handleMouseBlur}>
          <div className={styles['item__name']}>회사소개</div>
          <ul className={styles['item__contents']} onMouseEnter={handleMouseHover} onMouseOut={handleMouseBlur}>
